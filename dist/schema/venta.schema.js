...
const metodoPago_enums_1 = require("../enums/metodoPago.enums");
...
const MetodoPagoSchema = new mongoose_1.Schema({
    ...
    nombreMetodoPago: {
        ...
        enum: {
            values: Object.values(metodoPago_enums_1.MetodoPago),
...
VentaSchema.pre(['save', 'updateOne'], function (next) {
...
exports.VentaModel = (0, mongoose_1.model)('Venta', VentaSchema);
